...
export const DefaultPromts = [{
  ...
  id: 'gravityEarth',
  name: 'gravity earth (default)',
  promt: 'sv_gravity 800'
}, {
  id: 'gravityMercury',
  name: 'gravity mercury',
  promt: 'sv_gravity 302.4'
}, {
  id: 'gravityMoon',
  name: 'gravity moon',
  promt: 'sv_gravity 132.8'
}, {
  id: 'gravityMars',
  name: 'gravity mars',
  promt: 'sv_gravity 301.6'
}, {
  id: 'gravityJupiter',
  name: 'gravity jupiter',
  promt: 'sv_gravity 1888'
}, {
  id: 'gravityVenus',
  name: 'gravity venus',
  promt: 'sv_gravity 725.6'
}]